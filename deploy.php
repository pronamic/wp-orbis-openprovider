...
set( 'plugin_slug', 'orbis-openprovider' );
...
host( 'orbis.pronamic.nl' )
	...
	->set( 'port', 18765 )
	->set( 'deploy_path', '~/projects/wp-orbis-openprovider' )
...
task(
	'deploy:update_code',
	function () {
		upload( '{{build_path}}/orbis-openprovider/', '{{release_path}}' );
	}
);
